...
public final class AdaptiveActionApplier {
    ...
    private static volatile int baselineRenderDistance = -1;
    private static volatile int userPreferredMax = -1;
    private static volatile int lastObservedRd = -1;
    private static volatile int lastAppliedByWellNet = -1;
    private static volatile ActionPlan pendingPlan;
    private static volatile long lastApplyMs = 0L;
